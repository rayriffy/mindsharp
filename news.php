...
<head>
  ...
  <meta property="og:site_name" content="Mindsharp Story WIP"/>
...
<body id="top">
  ...
  <div class="section white">
    <div class="container">
        ...
        <div class="col l12 s12">
          <div class="card">
            <div class="card-content">
              <span class="card-title">News <b class="right">Page 1</b></span>
      ...
      <div class="row">
          <a href="./" class="btn blue waves-effect waves-light col l4 s4 right">BACK</a>
      </div>
    </div>
  </div>
